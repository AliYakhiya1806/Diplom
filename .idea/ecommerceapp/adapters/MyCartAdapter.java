package space.ali.ecommerceapp.adapters;
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(context, "Элемент жойылды", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(context, "Қате"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
